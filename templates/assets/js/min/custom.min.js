...
document.addEventListener("DOMContentLoaded", () => {
				...
				this.innerHTML = `
					<span class="joe_cloud">
						...
						<div class="joe_cloud__describe">
							...
							<div class="joe_cloud__describe-type">来源：${type[this.options.type] || "默认网盘"
					}${this.options.password ? " | 提取码：" + this.options.password : ""
					}</div>
						</div>
						<a class="joe_cloud__btn" href="${this.options.url
	...
	customElements.define(
		...
		class JoeDplayer extends HTMLElement {
			...
			render() {
				if (this.options.src)
					this.innerHTML = `<iframe allowfullscreen="true" class="joe_vplayer" src="${this.options.player + this.options.src
